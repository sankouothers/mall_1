...
<div class="container">
  ...
  <div class="well">
    ...
    <form:form action="editPassword" method="post" cssClass="form-horizontal" commandName="command">
      ...
      <c:if test="${page == 'edit'}">
        ...
        <spring:bind path="passWord">
          <div class="form-group ${status.error ? 'has-error' : ''}">
            ...
            <div class="col-sm-10">
              <form:input id="passWord" path="passWord" cssClass="form-control" placeholder=" Old PassWord"/>
      ...
      <spring:bind path="newPassWord">
        <div class="form-group ${status.error ? 'has-error' : ''}">
          ...
          <div class="col-sm-10">
            <form:input id="newPassWord" path="newPassWord" cssClass="form-control" placeholder="New Pass Word"/>
            <form:errors path="newPassWord" cssClass="alert-danger" element="div"/>
          </div>
        </div>
      </spring:bind>
